...
# HTML
## Create a HTML file to store data
...
!['HTML Interpretation'](https://raw.githubusercontent.com/GabrielSantos33/DATA607-Assignment-8/main/HTML%20interpreted.png)
...
# XML
## Create a XML file to store data
...
!['XML Source Code'](https://raw.githubusercontent.com/GabrielSantos33/DATA607-Assignment-8/main/HTML%20Source%20Code.png)
...
Therefore the attributes in \<Author\> is extracted separately.

  4. read XML file using function `read_XML`.
  5. find all node sets under tag \<Author\> using function `xml_nodes`.
  6. get the attributes (authors) of each note set using function `xml_attrs`.
  7. Concatenate the attributes of each note set into a single string separated by ', ' in order to fit these data into a column in a dataframe.
```{r}
#XML2 https://rpubs.com/Logan213/163136
attr <- url %>%
  xmlParse() %>%
...
!['JSON Source Code'](https://raw.githubusercontent.com/GabrielSantos33/DATA607-Assignment-8/main/JSON%20Source%20Code.png)
